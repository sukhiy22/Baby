...
module.exports.config = {
  ...
  description: "Automatically sends scheduled messages",
...
const messages = [
    ...
    { time: '8:00 AM', message: 'এখন সময় সকাল 8:00 AM ⏳\nপিও, মোবাইল রেখে কলেজে যাও অথবা ডিউটি তে যাও সময়ই তাকতে কাজে লাগাও!📱🪥🍽️', special: null },
...
module.exports.onLoad = ({ api }) => {
  if (global.config?.autoSent === false) return;
